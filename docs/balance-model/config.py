...
# ── Field sizes (§1) ─────────────────────────────────────────────────────────
FIELD_SIZE_MULT = {"small": 0.5, "medium": 1.0, "large": 2.0}
...
# ── Fertility (§1) ───────────────────────────────────────────────────────────
FERTILITY_DECAY = {"grains": 0.15, "roots": 0.25, "cash": 0.30, "weird": 0.10}
...
# ── Clones (§3) ──────────────────────────────────────────────────────────────
FOOD_PER_CLONE_DAY = 0.5
FOOD_PER_CLONE_DAY_WINTER = 0.75
FOOD_PER_FARMER_DAY = 1.0
FOOD_UNDERFEED = 0.25

...
**Milestone: 12/17 closed (#1–#8, #12–#15); #16 in progress.** Narrative & World Bible complete; Mechanics Bible now covers all core + supplementary systems; code-facing schema defined; event library covers all families (~71/120). Remaining: **#16** (event volume), **#10/#9** model (contracts/events, Ascension), **#11** paper playtest (needs user), **#17** monetization.

...
**Milestone: 14/17 closed (#1–#10, #12–#15); #16 in progress.** All design & validation issues closed except: **#16** (event volume, MVP-sufficient), **#11** paper playtest (needs user), **#17** monetization (a decision). The "Ready to Code" work is essentially complete.

...
**Milestone: 11/17 closed (#1–#7, #12, #13, #14, #15).** Narrative & World Bible substantially complete; the code-facing schema is now defined. Remaining: **#16** event library (~120 cards, authored against the schema), **#8** under-spec'd mechanics, **#10/#9** model (contracts/events, Ascension), **#11** paper playtest (needs user), **#17** monetization.

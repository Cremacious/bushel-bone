...
**Milestone: 16/17 closed (#1–#15, #17); only #16 open.** **All design, validation, decision, AND playtest work is COMPLETE.** The single remaining issue is **#16** (event volume toward ~120; already MVP-sufficient at ~71) — optional. Per the user's plan: finish #16, then **write code → playable browser build**.
